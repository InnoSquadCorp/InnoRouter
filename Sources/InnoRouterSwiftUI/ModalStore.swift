...
struct ModalObservationDelivery<M: Route> {
...
public final class ModalStore<M: Route> {
    ...
    internal let eventDispatcher: SerializedEventDispatcher<ModalObservationDelivery<M>>
    ...
    internal var effectiveTraceRecorder: InternalExecutionTraceRecorder? {
