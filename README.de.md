...
`RouterHost` besitzt den lokalen `NavigationStore`; für diesen einfachen Pfad
...
| View-Intent (erweitert) | `router.send(_:)`                     | Einen `NavigationIntent` dispatchen, für den es keine benannte Convenience-Methode gibt. |
