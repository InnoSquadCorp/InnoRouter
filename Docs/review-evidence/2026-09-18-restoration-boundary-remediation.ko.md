...
> 2026-09-19 정정: 이 문서의 완료 판정 이후 직접 복원의 stale 처리와 공개 입력 검증
> 누락을 확인했다. AC-006~012의 부족한 근거는
> [안전성 수정·재검토 기록](2026-09-19-restoration-safety.ko.md)에서 다시 확인한다.
> 아래 과거 명령의 통과 사실은 보존하되, 새 입력 경계까지 증명했다고 해석하지 않는다.
