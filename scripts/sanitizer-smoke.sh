...
case "$KIND" in
  thread)
    swift_filter='EventBroadcasterTests|RouterStateMachineTests|RouterStoreTests|RouterSceneLifecycleTests|RouterSignpostTrackerTests|RouterTestStoreTests|RouterScenarioCaptureTests|RouterTwelfthReviewRegressionTests|RouterTwelfthReviewReplayTests|RouterFeatureMappingTests|RouterPartialRestorationTests|RouterHistoryTests|RouterStateRestorationTests|RouterDeepLinkBehaviorTests|RouterLinkPipelineTests'
    ;;
  address)
    swift_filter='RouterLifecycleTests|RouterSceneLifecycleTests|RouterInspectorImportFuzzTests|RouterInspectorDiagnosticBundleTests|RouterInspectorTests|RouterInputFuzzTests|RouterStateMachineTests|RouterSignpostTrackerTests|RouterSnapshotTests|RouterScenarioCaptureTests|RouterTwelfthReviewRegressionTests|RouterTwelfthReviewReplayTests|RouterFeatureMappingTests|RouterPartialRestorationTests|RouterHistoryTests|RouterStateRestorationTests|RouterLinkPipelineTests'
    ;;
  *)
    usage
    exit 2
